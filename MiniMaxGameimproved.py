# -*- coding: utf-8 -*-
"""MiniMaxGameImproved.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1JUrIyhE_XuIv9b4TQMlDTzdykJmNDgGl
"""
...
class miniGame:
    ...
    def pos_eval(self,x,c):
        score=0
        for i in range(len(x)):
            if x[i]==c:
                if i==2 or i==7 or i==16 or i==10:
                    score=score+15
                elif i==0 or i==4 or i==6 or i==8 or i==9 or i==11 or i==13 or i==19:
                    score=score+2
                else:
                    score=score-2
        return score
    ...
    def StaticEstimation(self,x):
        ...
        w_pos_score=self.pos_eval(x,'W')
        b_pos_score=self.pos_eval(x,'B')
        #print(mob_score_W-mob_score_B)
        #print(w_pos_score-b_pos_score)
        for i in x:
            if i=='W':
                White=White+1
            elif i=='B':
        ...
        if Black<=2:
            ...
            return ((5*(White-Black)+4*(whitemills-blackmills))-2*((mob_score_W-mob_score_B)/White+Black))
